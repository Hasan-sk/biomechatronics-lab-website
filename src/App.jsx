...
const publications = [
  "Mashud G. A., Hasan S., Alam N. Advances in Control Techniques for Rehabilitation Exoskeleton Robots: A Systematic Review. Actuators, 2025.",
  "Alam N., Hasan S., Mashud G. A., Bhujel S. Neural Network for Enhancing Robot-Assisted Rehabilitation: A Systematic Review. Actuators, 2025.",
  "Hasan S. K. A Realistic Model Reference Computed Torque Control Strategy for Human Lower Limb Exoskeletons. Actuators, 2024.",
  "Bhujel S., Hasan S. K. A Comparative Study of End-Effector and Exoskeleton Type Rehabilitation Robots in Human Upper Extremity Rehabilitation. Human-Intelligent Systems Integration, 2023.",
  "Hasan S. K., Dhingra A. K. Biomechanical Design and Control of an Eight-DOF Human Lower Extremity Rehabilitation Exoskeleton Robot. Results in Control and Optimization, 2022.",
];
